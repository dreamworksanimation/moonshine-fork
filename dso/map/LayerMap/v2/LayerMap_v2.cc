...
#include "LayerMap_v2_ispc_stubs.h"
...
RDL2_DSO_CLASS_BEGIN(LayerMap_v2, scene_rdl2::rdl2::Map)

public:
    LayerMap_v2(const scene_rdl2::rdl2::SceneClass& sceneClass, const std::string& name);
    ~LayerMap_v2();
    virtual void update();
...
RDL2_DSO_CLASS_END(LayerMap_v2)


//---------------------------------------------------------------------------

LayerMap_v2::LayerMap_v2(const scene_rdl2::rdl2::SceneClass& sceneClass, const std::string& name) :
    Parent(sceneClass, name)
{
    mSampleFunc = LayerMap_v2::sample;
    mSampleFuncv = (scene_rdl2::rdl2::SampleFuncv) ispc::LayerMap_v2_getSampleFunc();
}
...
void
LayerMap_v2::sample(const scene_rdl2::rdl2::Map* self, moonray::shading::TLState *tls,
                 const moonray::shading::State& state, Color* sample)
{
    const LayerMap_v2* me = static_cast<const LayerMap_v2*>(self);
